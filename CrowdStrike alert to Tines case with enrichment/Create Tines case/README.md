...
This step writes to Tines. Re-running it creates another case; there is no dedupe on composite ID.
...
Output: the upstream payload plus `tines_case` (`case_id`, `url`, `name`, `priority`).
