Serves service-ownership and ticket-routing records (owner, SPOC, Slack channel, ticketing target, project, component).

**Trigger:** HTTP `GET /vulndata/owners` â authenticated as `connector`, so other workflows in the tenant can call it through a workflow-backed connector pointing at this workflow.
